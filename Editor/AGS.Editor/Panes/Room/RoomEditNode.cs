...
namespace AGS.Editor.Panes.Room
{
    public class RoomEditNode : IAddressNode
    {
        ...
        private bool _visibleByDefault, _allowDelete, _shouldHideCheckboxes;
        ...
        public bool AllowDelete
        {
            ...
            {
                _allowDelete = value;
                if (_control != null) _control.AllowDelete = value;
            }
        }
        ...
        public ToolStripItem CreateNodeUI(EventHandler nodeClicked)
        {
            ...
            if (_control != null)
            {
                ...
                _control.OnDeleteClicked -= control_OnDeleteClicked;
            }
            ...
            control.OnDeleteClicked += control_OnDeleteClicked;
        ...
        private void control_OnDeleteClicked(object sender, EventArgs e)
        {
            IRoomEditorFilter parentFilter = FindFilter();
