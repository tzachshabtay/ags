...
namespace AGS.Editor
{
    public interface IRoomEditorFilter : IDisposable
    {
        ...
        bool SupportsAddAndDelete { get; }
        string AddNewItem(); //Will throw an exception if SupportsAddAndDelete returns false
        void DeleteLastItem(); //Will throw an exception if SupportsAddAndDelete returns false
