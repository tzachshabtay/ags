...
namespace AGS.Editor
{
    public class ObjectsEditorFilter : IRoomEditorFilter
    {
        ...
        public bool SupportsAddAndDelete { get { return false; } }

        public string AddNewItem()
        {
            throw new NotSupportedException("Does not support adding item from navigation bar");
        }

        public void DeleteLastItem()
        {
            throw new NotSupportedException("Does not support deleting item from navigation bar");
        }
