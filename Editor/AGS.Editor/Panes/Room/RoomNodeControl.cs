...
namespace AGS.Editor.Panes.Room
{
    ...
    {        
        public RoomNodeControl()
        {
            ...
            this.deleteButton.MouseEnter += RoomNodeControl_MouseEnter;
            ...
            this.deleteButton.MouseLeave += RoomNodeControl_MouseLeave;
        ...
        public event EventHandler OnDeleteClicked { add { deleteButton.Click += value; } remove { deleteButton.Click -= value; } }
